...
public class GetOne {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//String value of the employee id to display
			String id = "3";
			...
			URL oneEmployee = new URL(endpoint + "?" + queryString);
			
			HttpURLConnection connection = (HttpURLConnection) oneEmployee.openConnection();
